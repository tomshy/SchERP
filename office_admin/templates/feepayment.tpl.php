				  ...
				  <td colspan="4" align="center" class="narmal">No Fees for this Class</td>
						  ...
						  <?php }  ?>	
                                                        <tr>
                                                            ...
                                                            <td align="right"><strong>Ksh. <?php echo number_format($total_fee, 2, '.', ''); ?></strong></td>
		  ...
		  <div id="paybutton" style="display:block">
                           ...
                           <td>
                               ...
                               <table width="90%" align="center">
                                   <tr>
                                       ...
                                       <td>
                                            Ksh. <input type="text" name="remaining" id="remaining" readonly value="<?php echo $remaining; ?>" />
                                       </td>
                                   </tr>
                                   <tr>
                                       <td>
                                       ...
                                       <td>
                                            Ksh. <input type="text" name="remaining_after_current" id="remaining_after_current" readonly value="" />
                                       </td>
                                   </tr>
                                   <tr>
                                       <td></td>
                  ...
                  <table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" class="tbl_grid" >
                      <tr class="bgcolor_02" height="25">
                        ...
                        <td align="left" class="admin" width="18%" style="padding-left: 20px;">Amount (Ksh)</td>
                      </tr>
	...
	foreach($otherfine_det as $each){
		...
		/*	echo  $sql_prev_month_bal = "SELECT balance  FROM es_feepaid_new  WHERE es_preadmissionid = ".$studentid." AND financemaster_id='".$pre_year."' AND balance > 0 ORDER BY fid DESC ";*/
              ...
              <script type="text/javascript" >
				...
				function showAvatar(){
					...
					if (ch=='cash' || ch==''){
						...
						document.getElementById("mpesaDiv").style.display="inline";
						document.getElementById("patiddivdisp").style.display="none";
					}else{
			...
			?>
              ...
              <tr>
                <td colspan="4"><table width="100%" border="1" cellspacing="0" cellpadding="4"  id="mpesaDiv" style="<?php if(isset($es_paymentmode)&&$es_paymentmode=="mpesa"){ echo 'display:block;';}else{echo 'display:none;';}?>" class="tbl_grid" >
                    <tr>
                      <td align="left" class="bgcolor_02" colspan="3">Mpesa Details </td>
                    </tr>
                    <tr>
