    ...
    <td align="center" valign="top"><table width="1002" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td align="left" valign="top" class="bb_mid"><table width="100%" height="482" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td height="328" style="padding-top:20px;">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td height="308" align="center" style="background:#FFFFFF"><table width="850" height="336" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="200" height="336" align="left" valign="top" class="loginbg"><table width="100%" height="294" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="6%" height="33">&nbsp;</td>
                          <td width="94%" align="left" valign="middle" height="33" ><table width="500" border="0">
  <tr>
    <td width="320" align="center" valign="top" class="success_message"><?php if(isset($emsg) && $emsg!=""){echo $sucessmessage[$emsg];}?></td>
  </tr>
                        ...
                        <tr>
                          ...
                          <table width="100%" height="234" border="0" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                              ...
                              <td width="105" height="21" align="left" valign="middle" class="t1">Username</td>                              
